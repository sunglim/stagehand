...
# Globally install grinder, test_runner.
...
run_tests --content-shell-bin ./drt-lucid64-full-stable-42039.0/content_shell test/all_test.dart test/web_test.dart
